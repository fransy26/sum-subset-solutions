...
public class Main {
    ...
    public static final Integer NB_SOLUTIONS_MAX = 50000000;
    ...
    private static final List<Integer> VALUES_LIST_10 = new ArrayList<>((new HashSet<>(List.of(1498, 439,  34, 243, 50, 1898, 109, 117, 100, 162))));

    private static final List<Integer> VALUES_LIST_35 = new ArrayList<>((new HashSet<>(List.of(153,27,56,462,195,377,16,33,38,419,59,312,93,15,112,103,91,65,
        173,49,24,47,374,39,73,438,26,2000,115,16,293,21,60,227))));

    private static final List<Integer> VALUES_LIST_50 = new ArrayList<>((new HashSet<>(List.of(153,27,56,462,195,377,16,33,38,419,59,312,93,15,112,103,91,65,
        173,49,24,47,374,39,73,438,26,2000,115,16,293,21,60,227,381,346,189,101,103,25,451,40,41,110,18,238,16,16,2,166))));

    private static final List<Integer> VALUES_LIST_100 = new ArrayList<>((new HashSet<>(List.of(153,27,56,462,195,377,16,33,38,419,59,312
        ,93,15,112,103,91,65,173,49,24,47,374,39,73,438,26,2000,115,16,293,21,60,227,381,346,189,101,103,25,451,40,41,110,18,238,16,16,2,166,
        141,76,152,46,18,335,119,94,46,89,188,295,422,98,280,2327,45,147,100,235,74,893,15,8,220,30,109,135,25,226,36,666,134,711,
        386,253,345,26,33,5,69,217,104,81,143,33,276,13,111,1530))));

    private static Map<Integer, List<Integer>> TEST_VALUES = Map.ofEntries(
        entry(9, VALUES_LIST_1),
        entry(6, List.of(3, 2, 7, 1)),
        entry(2000, VALUES_LIST_10),
        entry(3000, VALUES_LIST_30),
        entry(3010, VALUES_LIST_35),
        entry(8688, VALUES_LIST_50),
        entry(8693, VALUES_LIST_50),
        entry(20656, VALUES_LIST_100)
    );
    ...
    public static void main(String[] args) {
        ...
        TEST_VALUES.entrySet().forEach(entry -> {
            ...
            if (transactionList.size() <= 35) {
                resultList.add(RecursiveWay.getTestResult(transactionList, sum));
                if (transactionList.size() <= 10) {
                    resultList.add(RecursiveWayWithMemory.getTestResult(transactionList, sum));
                }
            }
